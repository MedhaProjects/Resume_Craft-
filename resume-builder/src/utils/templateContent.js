export const initialTemplate4Content= `<div style='font-family: Arial, sans-serif; color: #2c3e50; font-size: 14px;'>
...
export const initialTemplate1Content  = `<h1 style='text-align:center; font-size:22px; font-weight:bold; margin-bottom:10px;'>Medhavi Rampal</h1>
...
export const initialTemplate2Content= `<div style='font-family: Arial, sans-serif; color: #2c3e50; font-size: 14px;'>
  <h1 style='text-align:center; font-size:24px; font-weight:bold; color: #0a3d62;'>Medhavi Rampal</h1>
  <p style='text-align:center;'>
    📞 +91 8882376779 | 📧 medha8183@gmail.com | 🔗 <a href='https://linkedin.com/in/medhavi-rampal' target='_blank'>linkedin.com/in/medhavi-rampal</a> | 💻 <a href='https://github.com/medhavi' target='_blank'>github.com/medhavi</a>
  </p>
...
export const initialTemplate3Content = `<div style='font-family: Arial, sans-serif; color: #2c3e50; font-size: 14px;'>
...
export const initialTemplate5 = `<h1 style='text-align:center; font-size:24px; font-weight:bold; margin-bottom:10px;'>Medhavi Rampal</h1>
<p style='text-align:center; font-size:14px; margin-bottom:5px;'>Phone: +91 8882376779 | Email: medha8183@gmail.com</p>
<p style='text-align:center; font-size:14px; margin-bottom:10px;'>LinkedIn: linkedin.com/in/medhavi-rampal | GitHub: github.com/medhavi</p>
